...
const navigation = [
  ...
  { name: 'Employee Management', href: '/employee-management', icon: 'people' },
  { name: 'Documents', href: '/documents', icon: 'folder' },
  { name: 'Travel', href: '/travel', icon: 'flight' },
  { name: 'Hajj & Umrah', href: '/hajj-umrah', icon: 'mosque' },
  { name: 'Institutions', href: '/institutions', icon: 'business' },
  { name: 'Agents', href: '/agents', icon: 'person' },
  { name: 'Administration', href: '/administration', icon: 'settings' },
  { name: 'Reports & Analytics', href: '/reporting-analytics', icon: 'analytics' },
]
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h1 className="text-lg font-semibold text-gray-900">Ethio Agency Hub</h1>
            </div>
          </div>
          <button
            type="button"
